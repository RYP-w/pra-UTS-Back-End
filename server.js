...
import orderProductRoutes from './src/routes/orderProducts_routes.js';
import storeProductRoutes from './src/routes/storeProducts_routes.js';
...
app.use('/api/:orders/:idOrder/products', orderProductRoutes);
app.use('/api/stores/:idStore/products', storeProductRoutes);
