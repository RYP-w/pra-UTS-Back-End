...
async function createUser(req, res) {
  ...
  try {
    ...
    return sendResponseFormat(res, 201, 'Berhasil menambahkan user', { id: result.insertId });
  } catch (err) {
...
async function updateUserData(req, res) {
  ...
  try {
    ...
    return sendResponseFormat(res, 200, 'Berhasil mengupdate data user', null);
  } catch (err) {
    return sendResponseFormat(res, 500, 'Internal server error', null, err.message);
  }
}
...
async function deleteUser(req, res) {
  ...
  try {
    ...
    return sendResponseFormat(res, 200, `Berhasil menghapus user dengan id ${req.params.idUser}`, null);
  } catch (err) {
    return sendResponseFormat(res, 500, 'Internal server error', null, err.message);
  }
}
